ed de# Remove Hardcoded ESLint no-unused-vars Override from cs-setup

## Steps:
- [x] Step 2: Regenerate hooks in test project: cd ../test-repo-01 && npx cs-setup check-hooks (running, husky reinstalled with updated hooks.js)
