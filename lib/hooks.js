...
# ---------------------------------------------------------------
echo -e "\n\\033[1;36m=====================================================================\\033[0m"
echo -e "\\033[1;36m STAGE 1/4: ESLint (Code Quality Check)\\033[0m"
...
if [ -n "$ESLINT_BIN" ]; then
  ...
  if [ $HAS_CONFIG -eq 1 ]; then
    ...
    if [ $ESLINT_EXIT -ne 0 ]; then
      echo ""
      echo -e "\\033[1;31m✖ [ESLint] Linting detected issues.\\033[0m"
      echo -e "\\033[1;33mTIP: To automatically fix these issues, run:\\033[0m"
      echo -e "\\033[1;33m  $DLX_CMD eslint --fix .\\033[0m"
      exit 1
    else
      echo -e "\\033[1;32m✔ [ESLint] Lint check passed.\\033[0m"
    fi
  else
...
# ---------------------------------------------------------------
echo -e "\n\\033[1;36m=====================================================================\\033[0m"
echo -e "\\033[1;36m STAGE 2/4: Gitleaks (Security & Secrets Scan)\\033[0m"
echo -e "\\033[1;36m=====================================================================\\033[0m"
...
if [ ! -f "$GITLEAKS_BIN" ]; then
  ...
  if [ $GITLEAKS_EXIT -ne 0 ]; then
    echo -e "\\033[1;31m✖ [Gitleaks] Secrets detected! Commit blocked.\\033[0m"
    exit 1
  fi

  echo -e "\\033[1;32m✔ [Gitleaks] No secrets found.\\033[0m"
fi
...
# ---------------------------------------------------------------
echo -e "\n\\033[1;36m=====================================================================\\033[0m"
echo -e "\\033[1;36m STAGE 3/4: Code Coverage (Jest/Vitest)\\033[0m"
echo -e "\\033[1;36m=====================================================================\\033[0m"
...
if [ "$HAS_SOURCE_CHANGES" -eq 0 ]; then
  ...
  if [ -f "./node_modules/.bin/jest" ]; then
    ...
    echo -e "\\033[1;32m✔ [Coverage] Jest coverage report generated\\033[0m"
  elif [ -f "./node_modules/.bin/vitest" ]; then
    ./node_modules/.bin/vitest run --coverage 2>/dev/null || true
    echo -e "\\033[1;32m✔ [Coverage] Vitest coverage report generated\\033[0m"
  else
...
# ---------------------------------------------------------------
echo -e "\n\\033[1;36m=====================================================================\\033[0m"
echo -e "\\033[1;36m STAGE 4/4: SonarQube (Quality Gate)\\033[0m"
echo -e "\\033[1;36m=====================================================================\\033[0m"
...
if [ ! -f "sonar-project.properties" ]; then
  ...
  if grep -q "^sonar.login=REPLACE_WITH_YOUR_TOKEN" sonar-project.properties || \
    ...
    if [ $SONAR_EXIT -ne 0 ]; then
      echo ""
      echo -e "\\033[1;31m✖ [SonarQube] Quality Gate FAILED. Commit blocked.\\033[0m"
      echo ""
      echo -e "\\033[1;33m🔍 View issues on SonarQube dashboard:\\033[0m"
      echo -e "\\033[1;33m   URL:      \${SONAR_DASHBOARD_HOST}/dashboard?id=\${SONAR_DASHBOARD_KEY}\\033[0m"
      echo -e "\\033[1;33m   Username: $(git config user.email 2>/dev/null || echo 'your-git-email')\\033[0m"
      echo -e "\\033[1;33m   Password: Creole@123456\\033[0m"
      echo ""
      exit 1
    fi

    echo -e "\\033[1;32m✅ [SonarQube] Quality Gate Passed.\\033[0m"
    echo ""
